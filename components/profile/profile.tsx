...
const Profile: React.FC = () => {
  return (
    <div className=" text-foreground p-4 sm:p-8 md:p-12 lg:p-16 lg:px-[15vw] outline">
      ...
      <div className="flex justify-between gap-4">
        ...
        <div  className=" h-[25vw] w-[25vw] rounded-lg flex items-end">
        <Image
            src="/avatar/ava_orange.jpg"
            width={500}
            height={500}
            alt="Picture of the author"
            className="rounded-2xl h-[25vw] w-[25vw] absolute"
          />
        <div className="z-10  flex ml-5 mb-5">
            {/* <ion-icon size="large" name="trophy"></ion-icon> */}
            <div className="z-10">
              <p className="text-lg font-bold text-white">1200 Point</p>
            </div>
          </div>
