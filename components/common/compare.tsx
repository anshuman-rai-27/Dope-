...
export function CompareDemo() {
  ...
  return (
    <div className="p-4 flex justify-around items-center px-[15vw] gap-10 border rounded-3xl dark:bg-neutral-900 bg-neutral-100  border-neutral-200 dark:border-neutral-800 ">
